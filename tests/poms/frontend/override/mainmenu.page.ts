...
class MainMenuPage {
  ...
  constructor(page: Page) {
    ...
    this.minicartWrapper = page.locator('.minicart-wrapper');
    this.minicartCloseButton = page.locator('button[aria-label="Close minicart"]');
  }
  ...
  async openMiniCart() {
    ...
    await this.minicartWrapper.waitFor({ state: 'visible', timeout: 15000 });
  }
